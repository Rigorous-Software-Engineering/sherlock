...
static const int32_t * func_14(const int32_t * p_15, int32_t * p_16, int8_t  p_17);
...
{ /* block id: 0 */
    ...
    int32_t *l_7 = &l_2;
    int32_t *l_8 = &l_2;
    int32_t *l_9[3][6][3] = {{{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2}},{{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2}},{{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{&l_2,&l_2,&l_2},{(void*)0,&l_2,(void*)0},{&l_2,&l_2,&l_2}}};
    int32_t l_10 = (-3L);
    uint32_t l_11 = 7UL;
    int32_t **l_20 = &l_6;
    int32_t **l_21 = &l_9[0][4][2];
    int8_t l_27 = (-10L);
    int i, j, k;
    for (i = 0; i < 4; i++)
        l_4[i] = 0L;
    l_4[3] |= ((*l_3) = l_2);
    l_11--;
    (*l_21) = ((*l_20) = func_14(&l_2, &l_2, (*l_8)));
    for (l_10 = 26; (l_10 == (-30)); --l_10)
    { /* block id: 10 */
        for (l_2 = (-22); (l_2 <= 1); l_2++)
        { /* block id: 13 */
