...
static const int32_t  func_1(void)
{ /* block id: 0 */
    uint16_t l_6 = __VERIFIER_nondet_int();
    uint32_t l_7 = 18446744073709551609UL;
    int32_t l_9 = (-1L);
    int32_t *l_8 = &l_9;
    const uint16_t l_10[7] = {0xC781L,0xC781L,0xC781L,0xC781L,0xC781L,0xC781L,0xC781L};
    int i;
    (*l_8) |= ((safe_sub_func_int64_t_s_s(l_6, 0x45F1DBECCCE1E2C0LL)) || (l_6 == l_7));
    return l_10[5];
}
