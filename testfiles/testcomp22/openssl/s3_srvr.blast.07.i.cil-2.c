...
void reach_error() {
  __assert_fail("0", "s3_srvr.blast.07.i.cil-2.c", 3, "reach_error");
}
...
typedef void bio_info_cb(struct bio_st *, int, char const *, int, long, long);
...
struct dh_method {
  ...
  int (*bn_mod_exp)(DH *dh, BIGNUM *r, BIGNUM *a, BIGNUM const *p,
...
struct ssl3_enc_method {
  ...
  int (*final_finish_mac)(SSL *, EVP_MD_CTX *, EVP_MD_CTX *, char const *, int,
                          unsigned char *);
    ...
    if (init) {
      {
        ...
        tmp = (char *)tmp___0;
        memcpy((void *)((char *)(&SSLv3_server_data)), (void const *)tmp,
               sizeof(SSL_METHOD));
  ...
  {
    {
      ...
      if (__VERIFIER_nondet_int()) {
        ...
        (s->cert)->pkeys[0].privatekey =
            (struct evp_pkey_st *)__VERIFIER_nondet_ulong();
      }
