...
void reach_error() {
  __assert_fail("0", "simple_array_index_value_4.i.v+lhb-reducer.c", 4,
                "reach_error");
}
void abort(void);
          ...
          label_149:;
            {
              ...
              label_155:;
                ...
                if ((main__array[main__index1]) ==
                    (main__array[main__index2])) {
                  ...
                  if (main__index1 < main__index2) {
                    ...
                    label_132:;
                      if (main__index2 < main__index1) {
                        {
                          int __tmp_3;
                          __tmp_3 = (main__array[main__index1]) ==
                                    (main__array[main__index2]);
                          int __VERIFIER_assert__cond;
                          ...
                          label_125:;
                            unsigned int main____CPAchecker_TMP_3 =
                                main__index2;
                            main__index2 = main__index2 + 1;
                            unsigned int main____CPAchecker_TMP_4 =
                                main__index1;
                            main__index1 = main__index1 - 1;
                            goto label_132;
                          }
