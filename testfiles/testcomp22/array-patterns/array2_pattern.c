 ...
 * At mirror image from END of Array2, the element is also incremented with
 * -index. Sum of both array should be always zero.
 * */
...
void reach_error() {
  __assert_fail("0", "array2_pattern.c", 25, "reach_error");
}
extern void abort(void);
