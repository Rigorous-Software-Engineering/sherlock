...
void reach_error() {
  __assert_fail("0", "s3_clnt_3.BV.c.cil-1a.c", 3, "reach_error");
}
...
int ssl3_connect(void) {
  ...
  unsigned int s__ctx__stats__sess_connect = __VERIFIER_nondet_int();
