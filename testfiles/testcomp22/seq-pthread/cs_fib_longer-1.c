...
/*  Generated by CSeq 0.5 (-t2 -r7 -fcbmc) 2013-06-08 01:48:23  */
...
void *t1(void *arg) {
  ...
  for (k = 0; k < 6; k++) {
    ...
    // cseq: Translation for the assignment statement "i[__CS_round] +=
    // j[__CS_round]", case 2
...
void *t2(void *arg) {
  ...
  for (k = 0; k < 6; k++) {
    ...
    // cseq: Translation for the assignment statement "j[__CS_round] +=
    // i[__CS_round]", case 2
...
int main(int argc, char **argv) {
  ...
  for (k = 0; k < 7; k++) {
    ...
    for (l = 0; l < 3; l++) {
      ...
      __CS_cp___CS_thread_lockedon[k][l] =
  ...
  assume_abort_if_not(__CS_thread_status[0][0] ==
                      __CS_cp___CS_thread_status[1][0]); // cseq: Consistency of
                                                         // __CS_thread_status
  assume_abort_if_not(__CS_thread_status[1][0] ==
                      __CS_cp___CS_thread_status[2][0]);
  assume_abort_if_not(__CS_thread_status[2][0] ==
                      __CS_cp___CS_thread_status[3][0]);
  assume_abort_if_not(__CS_thread_status[3][0] ==
                      __CS_cp___CS_thread_status[4][0]);
  assume_abort_if_not(__CS_thread_status[4][0] ==
                      __CS_cp___CS_thread_status[5][0]);
  assume_abort_if_not(__CS_thread_status[5][0] ==
                      __CS_cp___CS_thread_status[6][0]);
  assume_abort_if_not(__CS_thread_status[0][1] ==
                      __CS_cp___CS_thread_status[1][1]);
  assume_abort_if_not(__CS_thread_status[1][1] ==
                      __CS_cp___CS_thread_status[2][1]);
  assume_abort_if_not(__CS_thread_status[2][1] ==
                      __CS_cp___CS_thread_status[3][1]);
  assume_abort_if_not(__CS_thread_status[3][1] ==
                      __CS_cp___CS_thread_status[4][1]);
  assume_abort_if_not(__CS_thread_status[4][1] ==
                      __CS_cp___CS_thread_status[5][1]);
  assume_abort_if_not(__CS_thread_status[5][1] ==
                      __CS_cp___CS_thread_status[6][1]);
  assume_abort_if_not(__CS_thread_status[0][2] ==
                      __CS_cp___CS_thread_status[1][2]);
  assume_abort_if_not(__CS_thread_status[1][2] ==
                      __CS_cp___CS_thread_status[2][2]);
  assume_abort_if_not(__CS_thread_status[2][2] ==
                      __CS_cp___CS_thread_status[3][2]);
  assume_abort_if_not(__CS_thread_status[3][2] ==
                      __CS_cp___CS_thread_status[4][2]);
  assume_abort_if_not(__CS_thread_status[4][2] ==
                      __CS_cp___CS_thread_status[5][2]);
  assume_abort_if_not(__CS_thread_status[5][2] ==
                      __CS_cp___CS_thread_status[6][2]);
  assume_abort_if_not(
      __CS_thread_lockedon[0][0] ==
      __CS_cp___CS_thread_lockedon[1][0]); // cseq: Consistency of
                                           // __CS_thread_lockedon
  assume_abort_if_not(__CS_thread_lockedon[1][0] ==
                      __CS_cp___CS_thread_lockedon[2][0]);
  assume_abort_if_not(__CS_thread_lockedon[2][0] ==
                      __CS_cp___CS_thread_lockedon[3][0]);
  assume_abort_if_not(__CS_thread_lockedon[3][0] ==
                      __CS_cp___CS_thread_lockedon[4][0]);
  assume_abort_if_not(__CS_thread_lockedon[4][0] ==
                      __CS_cp___CS_thread_lockedon[5][0]);
  assume_abort_if_not(__CS_thread_lockedon[5][0] ==
                      __CS_cp___CS_thread_lockedon[6][0]);
  assume_abort_if_not(__CS_thread_lockedon[0][1] ==
                      __CS_cp___CS_thread_lockedon[1][1]);
  assume_abort_if_not(__CS_thread_lockedon[1][1] ==
                      __CS_cp___CS_thread_lockedon[2][1]);
  assume_abort_if_not(__CS_thread_lockedon[2][1] ==
                      __CS_cp___CS_thread_lockedon[3][1]);
  assume_abort_if_not(__CS_thread_lockedon[3][1] ==
                      __CS_cp___CS_thread_lockedon[4][1]);
  assume_abort_if_not(__CS_thread_lockedon[4][1] ==
                      __CS_cp___CS_thread_lockedon[5][1]);
  assume_abort_if_not(__CS_thread_lockedon[5][1] ==
                      __CS_cp___CS_thread_lockedon[6][1]);
  assume_abort_if_not(__CS_thread_lockedon[0][2] ==
                      __CS_cp___CS_thread_lockedon[1][2]);
  assume_abort_if_not(__CS_thread_lockedon[1][2] ==
                      __CS_cp___CS_thread_lockedon[2][2]);
  assume_abort_if_not(__CS_thread_lockedon[2][2] ==
                      __CS_cp___CS_thread_lockedon[3][2]);
  assume_abort_if_not(__CS_thread_lockedon[3][2] ==
                      __CS_cp___CS_thread_lockedon[4][2]);
  assume_abort_if_not(__CS_thread_lockedon[4][2] ==
                      __CS_cp___CS_thread_lockedon[5][2]);
  assume_abort_if_not(__CS_thread_lockedon[5][2] ==
                      __CS_cp___CS_thread_lockedon[6][2]);
