...
int main() {
  ...
  assume_abort_if_not(flag1[0] ==
                      __CS_cp_flag1[1]); // cseq: Consistency of flag1
  assume_abort_if_not(flag1[1] == __CS_cp_flag1[2]);
  assume_abort_if_not(flag2[0] ==
                      __CS_cp_flag2[1]); // cseq: Consistency of flag2
  assume_abort_if_not(flag2[1] == __CS_cp_flag2[2]);
  assume_abort_if_not(turn[0] == __CS_cp_turn[1]); // cseq: Consistency of turn
