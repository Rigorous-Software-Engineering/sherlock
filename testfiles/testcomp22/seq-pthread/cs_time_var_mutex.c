...
int main() {
  ...
  assume_abort_if_not(block[0] ==
                      __CS_cp_block[1]); // cseq: Consistency of block
  ...
  assume_abort_if_not(inode[0] ==
                      __CS_cp_inode[1]); // cseq: Consistency of inode
  assume_abort_if_not(inode[1] == __CS_cp_inode[2]);
  assume_abort_if_not(m_inode[0] ==
                      __CS_cp_m_inode[1]); // cseq: Consistency of m_inode
  assume_abort_if_not(m_inode[1] == __CS_cp_m_inode[2]);
  assume_abort_if_not(m_busy[0] ==
                      __CS_cp_m_busy[1]); // cseq: Consistency of m_busy
