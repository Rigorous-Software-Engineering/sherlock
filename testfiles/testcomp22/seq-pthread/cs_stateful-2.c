...
int main() {
  ...
  assume_abort_if_not(ma[0] == __CS_cp_ma[1]); // cseq: Consistency of ma
  assume_abort_if_not(mb[0] == __CS_cp_mb[1]); // cseq: Consistency of mb
  assume_abort_if_not(data1[0] ==
                      __CS_cp_data1[1]); // cseq: Consistency of data1
  assume_abort_if_not(data2[0] ==
                      __CS_cp_data2[1]); // cseq: Consistency of data2
