...
void reach_error() {
  __assert_fail("0", "floppy_simpl4.cil-2.c", 3, "reach_error");
}
...
int IoBuildDeviceIoControlRequest(int IoControlCode, int DeviceObject,
                                  int InputBuffer, int InputBufferLength,
                                  int OutputBuffer, int OutputBufferLength,
                                  int InternalDeviceIoControl, int Event,
                                  int IoStatusBlock);
int IoDeleteSymbolicLink(int SymbolicLinkName);
int IoQueryDeviceDescription(int BusType, int BusNumber, int ControllerType,
                             int ControllerNumber, int PeripheralType,
                             int PeripheralNumber, int CalloutRoutine,
                             int Context);
...
int ObReferenceObjectByHandle(int Handle, int DesiredAccess, int ObjectType,
                              int AccessMode, int Object,
                              int HandleInformation);
int PsCreateSystemThread(int ThreadHandle, int DesiredAccess,
                         int ObjectAttributes, int ProcessHandle, int ClientId,
                         int StartRoutine, int StartContext);
...
int FlQueueIrpToThread(int Irp, int DisketteExtension) {
...

  {
    ...
    if (DisketteExtension__ThreadReferenceCount == 0) {
      ...
      {
        status = PsCreateSystemThread(threadHandle, 0, ObjAttributes, 0, 0,
                                      FloppyThread, DisketteExtension);
      }
      {
        if (status < 0) {
      ...
      {
        status = ObReferenceObjectByHandle(threadHandle, 1048576, 0, KernelMode,
                  ...
                  switch_0_5:
                    ...
                    if (!disketteExtension__IsStarted) {
                      ...
                      }
                      {
                        ...
                        ntStatus =
                            IofCallDriver(disketteExtension__TargetObject, Irp);
                      }
                      return (ntStatus);
                    }
                    {
                    ...
                    }
                    {
                      ...
                      if (__cil_tmp29 == 259L) {
                        {
                          KeWaitForSingleObject(disketteExtension__FloppyThread,
                        ...
                        }
                        {
                          ...
                          ntStatus = IofCallDriver(
                              disketteExtension__TargetObject, Irp);
                        }
                      } else {
                        {
                          ntStatus = -1073741823;
...
int FloppyStartDevice(int DeviceObject, int Irp) {
...

  {
    ...
    }
    {
      ...
      ntStatus =
          FlFdcDeviceIo(disketteExtension__TargetObject, __cil_tmp46, fdcInfo);
    }
    if (ntStatus >= 0) {
          ...
          while_0_continue: /* CIL Label */;
            ...
            }
            {
              ...
              ntStatus = IoQueryDeviceDescription(
                  fdcInfo__BusType, fdcInfo__BusNumber, Dc,
                  fdcInfo__ControllerNumber, Fp, fdcInfo__PeripheralNumber,
      ...
      if (ntStatus >= 0) {
        if (KUSER_SHARED_DATA__AlternativeArchitecture_NEC98x86 != 0) {
          ...
          // disketteExtension__DriveOnValue = fdcInfo__PeripheralNumber |
          // __cil_tmp49;
        }
        {
          pnpStatus = IoRegisterDeviceInterface(
              disketteExtension__UnderlyingPDO, MOUNTDEV_MOUNTED_DEVICE_GUID, 0,
              disketteExtension__InterfaceString);
        }
        if (pnpStatus >= 0) {
          {
            pnpStatus = IoSetDeviceInterfaceState(
                disketteExtension__InterfaceString, 1);
          }
        }
...
int FlFdcDeviceIo(int DeviceObject, int Ioctl, int Data) {
  ...
  {
    {
      irp = IoBuildDeviceIoControlRequest(Ioctl, DeviceObject, 0, 0, 0, 0, 1,
                                          doneEvent, ioStatus);
    }
    if (irp == 0) {
      return (-1073741670);
        ...
        if (tmp_ndt_2 == 1) {
          ...
          if (tmp_ndt_3 == 2) {
            ...
            if (tmp_ndt_4 == 3) {
              ...
              if (0) {
              switch_2_0 : { status = FloppyCreateClose(devobj, pirp); }
                goto switch_2_break;
              switch_2_1 : { status = FloppyCreateClose(devobj, pirp); }
                goto switch_2_break;
              switch_2_2 : { status = FloppyDeviceControl(devobj, pirp); }
                goto switch_2_break;
              switch_2_3 : { status = FloppyPnp(devobj, pirp); }
                goto switch_2_break;
              switch_2_default:;
                return (-1);
              } else {
    ...
    if (disketteExtension__HoldNewRequests) {
      {
        ...
        if (irpSp__Parameters__DeviceIoControl__IoControlCode___1 !=
            __cil_tmp41) {
                                              ...
                                              if (irpSp__Parameters__DeviceIoControl__IoControlCode___1 ==
                                              ...
                                              } else {
                                                {
                                                  ...
                                                  if (irpSp__Parameters__DeviceIoControl__IoControlCode___1 ==
                                                    ...
                                                    if (0) {
                                                    switch_13_exp_0:;
                                                      if (irpSp__Parameters__DeviceIoControl__OutputBufferLength <
                                                          sizeof__MOUNTDEV_NAME) {
                                                        ntStatus = -1073741811;
                                                        goto switch_13_break;
                                                      }
                                                      mountName =
                                                          Irp__AssociatedIrp__SystemBuffer;
                                                      mountName__NameLength =
                                                          disketteExtension__DeviceName__Length;
                                                      {
                                                        __cil_tmp82 =
                                                            sizeof__USHORT +
                                                            mountName__NameLength;
                                                    ...
                                                    switch_13_exp_1:;
                                                      ...
                                                      uniqueId =
                                                          Irp__AssociatedIrp__SystemBuffer;
                                                      uniqueId__UniqueIdLength =
                                                          disketteExtension__InterfaceString__Length;
                                                      {
                                                        __cil_tmp83 =
                                                            sizeof__USHORT +
                                                            uniqueId__UniqueIdLength;
                                                    ...
                                                    switch_13_exp_2:;
                                                    switch_13_exp_3:;
                                                      if (irpSp__Parameters__DeviceIoControl__InputBufferLength <
                                                          sizeof__FORMAT_PARAMETERS) {
                                                        ntStatus = -1073741811;
                                                        goto switch_13_break;
                                                      }
                                                      {
                                                      ...
                                                      }
                                                      {
                                                        ...
                                                        if (irpSp__Parameters__DeviceIoControl__IoControlCode___1 ==
                                                          ...
                                                          if (irpSp__Parameters__DeviceIoControl__InputBufferLength <
                                                            ...
                                                            if (formatExParameters__FormatGapLength >=
                                                                256) {
                                                              ntStatus =
                                                                  -1073741811;
                                                              goto switch_13_break;
                                                            } else {
                                                              if (formatExParameters__SectorsPerTrack >=
                                                                  256) {
                                                                ntStatus =
                                                                    -1073741811;
                                                                goto switch_13_break;
