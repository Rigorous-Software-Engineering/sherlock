...
void reach_error() {
  __assert_fail("0", "cdaudio_simpl1.cil-2.c", 3, "reach_error");
}
...
int AG_SetStatusAndReturn(int status, int Irp,
    ...
    if (deviceExtension__Active == 255) {
      ...
      status = -1073741823;
      {
        ...
        while_0_continue: /* CIL Label */;
          ...
          {
            status =
                SendSrbSynchronous(deviceExtension, srb, inquiryDataPtr, 36);
          }
        }
    ...
    if (irpSp__MinorFunction == 0) {
      ...
      if (irpSp__MinorFunction == 22) {
        ...
        switch_1_0 : {
          ...
          return (status);
        switch_1_22:;
          if (irpSp__Parameters__UsageNotification__Type !=
          ...
          {
            status =
                KeWaitForSingleObject(deviceExtension__PagingPathCountEvent,
...
int CdAudio535DeviceControl(int DeviceObject, int Irp) {
...

  {
    ...
    cdb = srb__Cdb;
    {
      ...
      __cil_tmp61 = 147456;
      __cil_tmp62 = 147512;
      if (currentIrpStack__Parameters__DeviceIoControl__IoControlCode ==
          __cil_tmp62) {
        goto switch_3_exp_0;
      } else {
        {
                                      ...
                                      } else {
                                        {
                                          ...
                                          if (currentIrpStack__Parameters__DeviceIoControl__IoControlCode ==
                                            ...
                                            switch_3_exp_0 : {
                                              ...
                                              Irp__IoStatus__Information =
                                                  bytesTransfered;
                                              if (lastSession__LogicalBlockAddress ==
                                                  0) {
                                                goto switch_3_break;
                                              }
                                            ...
                                            switch_3_exp_3:
                                              ...
                                              if (currentIrpStack__Parameters__DeviceIoControl__InputBufferLength <
                                                  sizeof__CDROM_PLAY_AUDIO_MSF) {
                                                status = -1073741820;
                                                goto switch_3_break;
                                              }
                                              if (inputBuffer__StartingM ==
                                                  inputBuffer__EndingM) {
                                                if (inputBuffer__StartingS ==
                                                    inputBuffer__EndingS) {
                                                  if (inputBuffer__StartingF ==
                                              ...
                                              }
                                              {
                                                ...
                                                srb__TimeOutValue = 10;
                                                status = SendSrbSynchronous(
                                                    deviceExtension, srb, 0, 0);
                                              }
                                              if (status >= 0) {
                                                if (cdb__PLAY_AUDIO_MSF__OperationCode ==
                                                    71) {
                                                }
                                              }
                                              goto switch_3_break;
                                            ...
                                            switch_3_default : {
                                              tmp___7 = CdAudioSendToNextDriver(
                                                  DeviceObject, Irp);
                                            }
                                              return (tmp___7);
                                              goto switch_3_break;
    ...
    {
      tmp___8 = AG_SetStatusAndReturn(status, Irp,
                                      deviceExtension__TargetDeviceObject);
    }
    return (tmp___8);
  }
      ...
      if (tmp_ndt_1 == 2) {
        ...
        if (tmp_ndt_2 == 3) {
          ...
          if (tmp_ndt_3 == 4) {
            ...
            if (0) {
            switch_5_2 : { status = CdAudioDeviceControl(devobj, pirp); }
              goto switch_5_break;
            switch_5_3 : { status = CdAudioPnp(devobj, pirp); }
              goto switch_5_break;
            switch_5_4 : { status = CdAudioPower(devobj, pirp); }
              goto switch_5_break;
            switch_5_default:;
              return (-1);
            } else {
    ...
    if (compRegistered) {
      if (routine == 0) {
        ...
        if (routine == 1) {
          {
            compRetStatus =
                CdAudioSignalCompletion(DeviceObject, Irp, lcontext);
          }
        }
      }
      {
