...
void reach_error() {
  __assert_fail("0", "apache-escape-absolute.i.v+cfa-reducer.c", 4,
                "reach_error");
}
void abort(void);
                                        ...
                                        label_287:;
                                          if (main__cp != (main__urilen - 1)) {
                                            ...
                                            main____CPAchecker_TMP_1 =
                                                __VERIFIER_nondet_int();
                                            if (!(main____CPAchecker_TMP_1 ==
                                                  0)) {
                                            label_289:;
                                              {
                                                int __tmp_5;
                                                __tmp_5 =
                                                    main__cp < main__urilen;
                                                int __VERIFIER_assert__cond;
