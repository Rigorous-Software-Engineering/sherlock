 ...
 * The list can form sequences 0, 01, 012, 0123^*. A particular sequence is
 * created during construction of the list nondeterministically. We remember
 * which sequence was actually created by an auxiliary integer variable. Then we
 * traverse the list and check that the sequence formed by the list corresponds
 * to the value of the auxiliary variable.
 *
