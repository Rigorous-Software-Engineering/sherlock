 ...
 * afterwards, go through it and check if the list does have the correct form,
 * and in particular finishes by a 0.
 *
...
// The function inserts one node of a random height to a randomly chosen
// position in between of the head and tail.
