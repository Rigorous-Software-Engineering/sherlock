...
int main(void) {
  ...
  stored_elements[1][0] =
      __CS_cp_stored_elements[1][0]; // cseq: Copy of stored_elements
  ...
  __VERIFIER_assume(
      stored_elements[0][0] ==
      __CS_cp_stored_elements[1][0]); // cseq: Consistency of stored_elements
  ...
  __VERIFIER_assume(
      enqueue_flag[0] ==
      __CS_cp_enqueue_flag[1]); // cseq: Consistency of enqueue_flag
  __VERIFIER_assume(
      dequeue_flag[0] ==
      __CS_cp_dequeue_flag[1]); // cseq: Consistency of dequeue_flag
  __VERIFIER_assume(queue[0].element[0] ==
                    __CS_cp_queue[1].element[0]); // cseq: Consistency of queue
