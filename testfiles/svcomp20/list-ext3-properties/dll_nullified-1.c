 ...
 * Create NULL-terminated dll (N0-N1-N2-N3-N4), s.t. Ni is a node with nullified
 * data fields. Violation: In a nondeterministic manner, put 1 into a data field
 * of a list element. After creation, traverse dll in both directions including
 * data checks.
 */
#include <stdlib.h>
