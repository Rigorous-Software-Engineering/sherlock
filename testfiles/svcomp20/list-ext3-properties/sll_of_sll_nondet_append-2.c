 ...
 * (N3)*(N4)*(N5)*, s.t. node Ni has a sublist of length i and occurs at most 10
 * times. Examples: (N3-N3-N3-N4-N5-N5) or (N3-N5-N5-N5). Then check if the
 * sublist lengths are in {3..5} and monotonically increase. Violation of
 * monotonicity assumption: Append a node with a sublist of length 3.
 */
#include <stdlib.h>
