...
static UINT32 Id_MCDC_95(UINT32 Id_MCDC_93, CHAR *Id_MCDC_94) {
  ...
  return ("35_39854_4294972318",
          __VERIFIER_assert(
              (long long)((Id_MCDC_94[0] * Id_MCDC_122) / Id_MCDC_121) >= 0 &&
              (long long)((Id_MCDC_94[0] * Id_MCDC_122) / Id_MCDC_121) <=
                  4294967295)),
         ((Id_MCDC_94[0] * Id_MCDC_122) / Id_MCDC_121);
}
UINT32 Id_MCDC_96(UINT16 Id_MCDC_82, UINT8 Id_MCDC_83, UINT32 *Id_MCDC_84,
                  UINT32 *Id_MCDC_85, INT32 *Id_MCDC_86, void **Id_MCDC_87) {
  Od_IndexTable *Id_MCDC_116;
