...
UINT32 Id_MCDC_107(UINT16 Id_MCDC_100, UINT8 Id_MCDC_101, UINT32 *Id_MCDC_102,
                   UINT32 *Id_MCDC_103, INT32 *Id_MCDC_104, void *Id_MCDC_105,
                   UINT8 Id_MCDC_106);
...
UINT32 Id_MCDC_114(UINT16 Id_MCDC_100, UINT8 Id_MCDC_101, UINT32 *Id_MCDC_102,
                   UINT32 *Id_MCDC_103, INT32 *Id_MCDC_104, void **Id_MCDC_105);
UINT32 Id_MCDC_115();
...
UINT32 Id_MCDC_107(UINT16 Id_MCDC_100, UINT8 Id_MCDC_101, UINT32 *Id_MCDC_102,
  ...
  if ((((UINT16)Id_MCDC_100 > (UINT16)Id_MCDC_123) &&
       ((UINT16)Id_MCDC_100 <= (UINT16)0x19FF)) ||
      (((UINT16)Id_MCDC_100 > (UINT16)Id_MCDC_124) &&
       ((UINT16)Id_MCDC_100 <= (UINT16)0x15FF))) {
    if (Id_MCDC_101 == 0x01) {
      return 0x00;
    }
  }
  ...
  case 0x1800:;
  case 0x1900:
    Id_MCDC_134 = Id_MCDC_125;
    break;
  case 0x1A00:;
  case 0x1B00:
    Id_MCDC_134 = Id_MCDC_126;
    break;
  case 0x1400:;
  case 0x1500:
    Id_MCDC_134 = Id_MCDC_127;
    break;
  case 0x1600:;
  case 0x1700:
    Id_MCDC_134 = Id_MCDC_128;
    break;
  default:
    Id_MCDC_134 = Id_MCDC_129;
    break;
  ...
  if (((Id_MCDC_101 == 0) ||
       (Id_MCDC_101 < Id_MCDC_134->Id_MCDC_0->Id_MCDC_88)) &&
      (strcmp((Id_MCDC_134->Id_MCDC_0->Id_MCDC_89 + Id_MCDC_101)->Id_MCDC_92,
              "rsvd"))) {
    if ((strcmp((Id_MCDC_134->Id_MCDC_0->Id_MCDC_89 + Id_MCDC_101)->Id_MCDC_92,
                "wo"))) {
      ;
    } else {
      return 0x06010001;
...
static UINT32 Id_MCDC_110(UINT32 Id_MCDC_108, UINT32 Id_MCDC_109) {
  ...
  } else if (Id_MCDC_108 < Id_MCDC_109) {
  ...
  while (Id_MCDC_137 != 0) {
    ...
    ("32_39888_4294972284",
     __VERIFIER_assert((long long)(Id_MCDC_135 / Id_MCDC_136) >= 0 &&
                       (long long)(Id_MCDC_135 / Id_MCDC_136) <= 4294967295)),
        Id_MCDC_138 = (UINT32)(Id_MCDC_135 / Id_MCDC_136);
...
UINT32 Id_MCDC_114(UINT16 Id_MCDC_100, UINT8 Id_MCDC_101, UINT32 *Id_MCDC_102,
                   UINT32 *Id_MCDC_103, INT32 *Id_MCDC_104,
                   void **Id_MCDC_105) {
  Od_IndexTable *Id_MCDC_134;
  Id_MCDC_134 = Id_MCDC_129;
  if (Id_MCDC_134 == ((void *)0)) {
...
UINT32 Id_MCDC_115() {
  ...
  if (Id_MCDC_141 <= 0x1803) {
    for (Id_MCDC_156 = 0; Id_MCDC_156 < 4; Id_MCDC_156++) {
      ...
      if (Id_MCDC_107(Id_MCDC_141, 1, &Id_MCDC_149, &Id_MCDC_148, &Id_MCDC_153,
                      (void *)&Id_MCDC_146, 0) != 0x00) {
        return 0xFFFF;
      }
      if (Id_MCDC_107(Id_MCDC_141, 2, &Id_MCDC_149, &Id_MCDC_148, &Id_MCDC_153,
                      (void *)&Id_MCDC_146, 0) != 0x00) {
        return 0xFFFF;
      }
      Id_MCDC_131.Id_MCDC_66->Id_MCDC_42[Id_MCDC_156].Id_MCDC_34 =
          (UINT8)Id_MCDC_146;
      Id_MCDC_141 = Id_MCDC_130[Id_MCDC_156];
      if (Id_MCDC_107(Id_MCDC_141, 0, &Id_MCDC_149, &Id_MCDC_148, &Id_MCDC_153,
                      (void *)&Id_MCDC_146, 0) != 0x00) {
        return 0xFFFF;
      }
      Id_MCDC_35 = (UINT8)Id_MCDC_146;
      for (Id_MCDC_150 = 0; Id_MCDC_150 < Id_MCDC_35; Id_MCDC_150++) {
        if (Id_MCDC_107(Id_MCDC_141, (Id_MCDC_150 + 1), &Id_MCDC_149,
                        &Id_MCDC_148, &Id_MCDC_153, (void *)&Id_MCDC_146,
                        0) != 0x00) {
          return 0xFFFF;
        }
        ...
        Id_MCDC_145 = Id_MCDC_114(Id_MCDC_142, Id_MCDC_152, &Id_MCDC_149,
                                  &Id_MCDC_148, &Id_MCDC_153, &Id_MCDC_154);
        if (Id_MCDC_145 != 0x00) {
          return Id_MCDC_145;
        }
      }
...
void Id_MCDC_117() {
  ...
  for (Id_MCDC_158 = 0; Id_MCDC_158 < 4; Id_MCDC_158++) {
    if ((Id_MCDC_131.Id_MCDC_66->Id_MCDC_42[Id_MCDC_158].Id_MCDC_34 <= 240) &&
        (Id_MCDC_131.Id_MCDC_66->Id_MCDC_42[Id_MCDC_158].Id_MCDC_34 >= 1)) {
      Id_MCDC_157[Id_MCDC_158] =
          Id_MCDC_131.Id_MCDC_66->Id_MCDC_42[Id_MCDC_158].Id_MCDC_34;
    } else {
