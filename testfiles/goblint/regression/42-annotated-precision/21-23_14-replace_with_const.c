// PARAM: --set ana.base.arrays.domain partitioned --set
// ana.base.partition-arrays.keep-expr "last" --enable
// ana.base.partition-arrays.partition-by-const-on-return --enable
