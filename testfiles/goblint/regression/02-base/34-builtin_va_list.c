...
void my__builtin_va_arg(__builtin_va_list arg0, unsigned long arg1,
                        void *arg2) {
  return;
}
...
void my__builtin_va_start(__builtin_va_list arg0) { return; }
void my__builtin_va_end(__builtin_va_list arg0) { return; }
