// PARAM: --disable sem.unknown_function.invalidate.globals --disable
// sem.unknown_function.spawn extracted from ddverify pcwd
...
static const struct file_operations pcwd_fops = {.ioctl = pcwd_ioctl};

static struct miscdevice pcwd_miscdev = {.fops = &pcwd_fops};
