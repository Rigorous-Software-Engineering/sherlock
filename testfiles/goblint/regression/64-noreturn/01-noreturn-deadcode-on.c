...
noreturn void does_not_return() { abort(); }

noreturn void does_return() {} // WARN

// with nested calls to noreturn functions, only warn that the innermost
// function returns

noreturn void chain0() {} // WARN

noreturn void chain1() { chain0(); } // NOWARN!

noreturn void chain2() { chain1(); } // NOWARN!
