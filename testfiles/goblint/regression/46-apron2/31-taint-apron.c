// SKIP PARAM: --set ana.activated[+] taintPartialContexts --set
// ana.activated[+] apron --set ana.ctx_insens[+] apron
...
int f2(int *aptr, int *bptr) { *aptr = 7; }

int f3(int *aptr, int *bptr) { *aptr = *bptr; }
