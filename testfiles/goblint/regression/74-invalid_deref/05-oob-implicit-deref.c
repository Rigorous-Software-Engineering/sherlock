...
/*
    ...
    since the GitHub CI seems to be considering Info messages as violations of
   NOWARN (cf. https://github.com/goblint/analyzer/issues/1151)
*/
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
int main(int argc, char const *argv[]) {
  ...
  // Both lines below are considered derefs => no need to warn, since ptr is
  // pointing within its bounds
