// PARAM: --enable ana.int.interval_set --set ana.base.arrays.domain unroll
// --set ana.base.arrays.unrolling-factor 2
...
void example2() {
  // no char because char has unknown signedness (particularly, unsigned on
  // arm64)
  signed char a[10];
  int n;
