...
// --disable ana.int.def_exc --disable ana.int.enums
//  Examples taken from P. Granger "Static analysis of arithmetical congruences"
//  (1989, International Journal of Computer Mathematics)
