// SKIP PARAM: --set ana.activated[+] affeq --sem.int.signed_overflow
// "assume_none"  --enable ana.int.interval
//  Snippet from
//  https://github.com/sosy-lab/sv-benchmarks/blob/master/c/nla-digbench/hard2.c
