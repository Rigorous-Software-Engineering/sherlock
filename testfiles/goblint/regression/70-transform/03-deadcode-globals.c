...
const struct struct1 struct1_value1 = {.field1 = 0, .field2 = 'a'};

struct1_named3 const struct_f() { return struct1_value1; }

int struct_pointer_f(struct1_named4 *x) { return x->field1 + 1; }
