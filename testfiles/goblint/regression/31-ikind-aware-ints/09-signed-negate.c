// PARAM: --disable ana.int.interval --set sem.int.signed_overflow
// assume_wraparound
...
int main() {
  ...
  // Signed overflow - The following assertion only works with
  // sem.int.signed_overflow set to assume_wraparound
