// PARAM: --enable ana.int.interval_set --enable ana.int.congruence --disable
// ana.int.def_exc Overflow information should be passed from the interval
// domain to congruences
