...
void CWE590_Free_Memory_Not_on_Heap__free_struct_alloca_54b_badSink(
    twoIntsStruct *data) {
  CWE590_Free_Memory_Not_on_Heap__free_struct_alloca_54c_badSink(data);
  return;
}

void CWE590_Free_Memory_Not_on_Heap__free_struct_alloca_54c_badSink(
    twoIntsStruct *data) {
  CWE590_Free_Memory_Not_on_Heap__free_struct_alloca_54d_badSink(data);
  return;
}

void CWE590_Free_Memory_Not_on_Heap__free_struct_alloca_54d_badSink(
    twoIntsStruct *data) {
  CWE590_Free_Memory_Not_on_Heap__free_struct_alloca_54e_badSink(data);
  return;
}

void CWE590_Free_Memory_Not_on_Heap__free_struct_alloca_54e_badSink(
    twoIntsStruct *data) {
  free((void *)data); // WARN
  return;
}
